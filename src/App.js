...
function App() {
    ...
    const fetchContent = async (selectedFeeling) => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/feeling/${selectedFeeling}/ayat`);
    ...
    const fetchMoreAyat = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/feeling/${feeling}/ayat`);
            console.log("API response:", response.data);
            setAyat(response.data.text);
        } catch (error) {
    ...
    const fetchMoreHadith = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/feeling/${feeling}/hadith`);
            console.log("API response:", response.data);
            setAyat(response.data.text);
        } catch (error) {
